...
public class MainPage extends javax.swing.JFrame {
    ...
    public void listele(List<Musteri> mlist){
        musteriService = new MusteriService();
        /**
         * Servis katmanı aracılığı ile tüm müşteri listesini çekiyoruz.
         */
        if(mlist == null)
          mlist = musteriService.findAll();
        /**
         * Müşteri listeniz içinde müşterileri tek tek çekiyor ve bilgilerini tablo içine ekliyoruz.
         */
        tabloTemizle();
    ...
    private void atomikListele(){
        ...
        /**
         * bu asenkron çalışır bu nedenle burada primitive data type kullanamazsınız.
         * 
         */
        mlist.forEach(mst->{
    ...
    private void initComponents() {
        ...
        tabloMusteri.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tabloMusteriKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tabloMusteriKeyReleased(evt);
            }
        });
    ...
    private void btnKaydetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKaydetActionPerformed
        ...
        JOptionPane.showMessageDialog(rootPane, "Müşteri kayıt işlemi tamamlandı.");
            ...
            Musteri musteri = new Musteri(Long.valueOf(txtId.getText()),ad,adres,telefon,"",cinsiyet,1);
            musteriService.update(musteri);
            JOptionPane.showMessageDialog(rootPane, "Update islemi gerceklesti..");
        }
        listele(null);
        acKapat(false);
    ...
    private void tabloMusteriKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabloMusteriKeyReleased
      
    }//GEN-LAST:event_tabloMusteriKeyReleased

    private void tabloMusteriKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabloMusteriKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tabloMusteriKeyPressed
    ...
    private void btnSilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSilActionPerformed
       ...
       if(selectRow == -1){
           JOptionPane.showMessageDialog(rootPane, "Lutfen bir satir seciniz..");
       }else{
          int secim = JOptionPane.showConfirmDialog(rootPane,
                   "Secilen kayit silinecektir emin misiniz?",
                   "DIKKAT !! Kayit Silme",
          ...
          if(secim == JOptionPane.YES_OPTION){
           ...
           JOptionPane.showMessageDialog(rootPane, id+" ID numarali musteri silindi..");
           listele(null);
          }else{
              JOptionPane.showMessageDialog(rootPane,"Silme islemi iptal edilmistir..");
          }
       }
    ...
    private void btnDüzenleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDüzenleActionPerformed
        ...
        txtId.setText(tabloMusteri.getValueAt(selectRow,1).toString());
        txtId.setText(tabloMusteri.getValueAt(selectRow,4).toString());
        txtId.setText(tabloMusteri.getValueAt(selectRow,2).toString());
        cmbCinsiyet.setSelectedItem(tabloMusteri.getValueAt(selectRow,3).toString());
        acKapat(true);
